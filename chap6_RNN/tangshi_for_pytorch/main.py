        ...
        for batch in range(n_chunk):
            ...
            for index in range(BATCH_SIZE):
                ...
                if index == 0:
                    ...
                    print('prediction', pre.data.detach().cpu().tolist()) # the following  three line can print the output and the prediction
                    print('b_y       ', y.data.detach().cpu().tolist())   # And you need to take a screenshot and then past is to your homework paper.
                    print('*' * 30)
...
def gen_poem(begin_word):
    ...
    while word != end_token:
        ...
        word = to_word(output.data.detach().cpu().tolist()[-1], vocabularies)
        poem += word
        # print(word)
        # print(poem)
        if len(poem) > 30:
